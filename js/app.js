...
document.querySelectorAll('.nav-item').forEach(el=>{
  el.addEventListener('click',()=>{
    ...
    const titles={dashboard:'Dashboard general',comunicados:'Comunicados',vencimientos:'Control de vencimientos',incidencias:'Incidencias de recepción',limpieza:'Limpieza',auditorias:'Auditorías de Tienda',caidas:'Caídas de Servicio (Luz / SIP)',personal:'Mi equipo',horarios:'Horarios semanales',evaluaciones:'Evaluaciones'};
